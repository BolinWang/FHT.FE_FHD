    ...
    <el-tabs type="border-card" v-model="type" @tab-click="chooseTab">
      <el-tab-pane :label="item.value" :name="item.key" v-for="(item, index) in recordType" :key="index">
        <div class="search-box">
          <el-input v-if="item.key==1" style="width:300px;" size="small" placeholder="离职人员姓名／手机号码／身份证号" v-model="keyword" clearable>
          </el-input>
          <el-input v-else style="width:300px;" size="small" placeholder="复职人员姓名／身份证号" v-model="keyword" clearable>
          </el-input>
